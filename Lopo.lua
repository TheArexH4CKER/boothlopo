...
getgenv().Settings = {
    ...
    Seller = {
        ...
        Items = {
            ...
            ["2024 X-Large Christmas Present"] = {Class = "Lootbox", Price = "-3%"},
            ["2024 Large Christmas Present"] = {Class = "Lootbox", Price = "-3%"},
            ["2024 Medium Christmas Present"] = {Class = "Lootbox", Price = "-3%"},
            ["2024 Small Christmas Present"] = {Class = "Lootbox", Price = "-3%"},
