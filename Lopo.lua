...
getgenv().Settings = {
    ...
    Seller = {
        ...
        Items = {
            ...
            ["Snowflake Gift"] = {Class = "Lootbox", Price = 56500},
            ["2024 Gargantuan Christmas Present"] = {Class = "Lootbox", Price = 45000000},
            ["2024 X-Large Christmas Present"] = {Class = "Lootbox", Price = "-7%"},
            ["2024 Large Christmas Present"] = {Class = "Lootbox", Price = "-7%"},
            ["2024 Medium Christmas Present"] = {Class = "Lootbox", Price = "-7%"},
            ["2024 Small Christmas Present"] = {Class = "Lootbox", Price = "-7%"},
